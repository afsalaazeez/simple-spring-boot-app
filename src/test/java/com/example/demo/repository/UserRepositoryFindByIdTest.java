...
class UserRepositoryFindByIdTest {
	...
	void findByIdWithExistingUserReturnsOptionalWithUser() {
		...
		// Alice Johnson should have ID 1L
		// Act
	...
	void findByIdWithNonExistingIdReturnsEmptyOptional() {
		// Arrange - UserRepository is initialized with sample data (IDs 1, 2, 3)
		// Act
	...
	void findByIdWithNullIdReturnsEmptyOptional() {
		// Arrange - UserRepository is initialized with sample data
		// Act & Assert
	...
	void findByIdWithZeroIdReturnsEmptyOptional() {
		// Arrange - UserRepository is initialized with sample data
		// idGenerator starts at 1, so ID 0 should not exist
		// Act
	...
	void findByIdReturnsCorrectUserFromMultipleUsers() {
		// Arrange - UserRepository is initialized with 3 users
		// Bob Smith should have ID 2L
		// Act
	...
	void findByIdAfterUpdateReturnsUpdatedUser() {
		// Arrange
		Optional<User> existingUserOpt = userRepository.findById(1L);
	...
	@Test
	@Tag("valid")
	void findByIdReturnsThirdUserCorrectly() {
		// Arrange - Charlie Brown should have ID 3L
		// Act
	...
	@Test
	@Tag("valid")
	void findByIdReturnedUserHasValidId() {
		// Arrange & Act
		Optional<User> result = userRepository.findById(1L);
		// Assert
		assertTrue(result.isPresent());
	...
	void findByIdWithMinLongValueReturnsEmptyOptional() {
		// Arrange - UserRepository is initialized with sample data
		// Act
		Optional<User> result = userRepository.findById(Long.MIN_VALUE);
		// Assert
		assertTrue(result.isEmpty());
	}
